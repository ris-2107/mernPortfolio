...
const AdminPanel = () => {
  ...
  useEffect(() => {
    if (error) {
      enqueueSnackbar(error, { variant: "error", autoHideDuration: 1250 });
      dispatch({ type: "CLEAR_ERRORS" });
    }
    if (message) {
     enqueueSnackbar(message, { variant: "success", autoHideDuration: 1250 });
      dispatch({ type: "CLEAR_MESSAGE" });
    }
    if (loginMessage) {
      enqueueSnackbar(loginMessage, { variant: "success", autoHideDuration: 1250 });
      dispatch({ type: "CLEAR_MESSAGE" });
    }
  ...
  return (
    <div className="adminPanel">
      <div className="adminPanelContainer">
        ...
        <Typography style={{fontSize:"3.4rem", fontWeight:"500", backgroundColor:"#ffd9b3"}} variant="h4">
          <p>A</p>
          <p>D</p>
          <p>M</p>
          <p>I</p>
        ...
        <form onSubmit={submitHandler}>
          ...
          <div className="adminPanelSkill">
            <div>
              <Typography style={{fontWeight:"500", fontSize:"3.2rem"}}>SKILL 1</Typography>
              <input
            ...
            <div>
              <Typography style={{fontWeight:"500", fontSize:"3.2rem"}}>SKILL 2</Typography>
            ...
            <div>
              <Typography style={{fontWeight:"500", fontSize:"3.2rem"}} >SKILL 3</Typography>
            ...
            <div>
              <Typography style={{fontWeight:"500", fontSize:"3.2rem"}}>SKILL 4</Typography>
            ...
            <div>
              <Typography style={{fontWeight:"500", fontSize:"3.2rem"}}>SKILL 5</Typography>
            ...
            <div>
              <Typography style={{fontWeight:"500", fontSize:"3.2rem"}} >SKILL 6</Typography>
          ...
          <div className="adminPanelAbout">
            <fieldset>
              <legend style={{fontSize:"2.6rem"}}>About</legend>
              <input
                type="text"
                placeholder="Name"
                value={about.name}
